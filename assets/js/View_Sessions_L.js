                ...
                for (var i = 0; i < response.length; i++) {
                    ...
                    var sessionItem = '<div class="col-lg-4 col-md-6">' +
                                          '<div class="plan text-center mb-30">' +
                                              ...
                                              if (session.Status === 'Completed' ) { sessionItem += '<a href="../HTML%20pages/Partner%20Review%20-%20Learner.html?sessionId=' + session.SessionID + '" class="theme_btn price_btn active">Rate Partner!</a>'; } 
