...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../assets/css/Filter Italien.css">
                      ...
                      <div class="page-title-wrapper mb-50">
                         ...
                         <div class="breadcrumb-list">
                            <ul class="breadcrumb">
                                ...
                                <li><a href="Partnerlist Italien.php#Here">Partner List</a></li>
                            </ul>
                         </div>
                    </div>
                  </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-12 text-center">
                    <div class="portfolio-menu mb-30">
                        ...
                        <button class="gf_btn active" data-filter='.cat5'>Italien</button>
