...
<head>
    <meta charset="utf-8">
    <title>Home page of partner </title>
                                        ...
                                        <ul class="navbar-nav">
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown3">
                                                    <li><a class="dropdown-item" href="View Reviews.php">View my ratings</a></li>
                            ...
                            <div class="right-nav d-flex align-items-center justify-content-end">
                                <div class="right-btn mr-25 mr-xs-15">
                                    <ul class="d-flex align-items-center">
                                        ...
                                        <li><a class="sign-in ml-20" href="Profile Page-Language Partner.php"><img src="../assets/img/icon/user.svg" alt=""></a></li>
                                    </ul>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6">
                            <div class="slider__content slider__content__02 pt-120">
                                ...
                                <h1 class="main-title mb-40 wow fadeInUp2 animated" data-wow-delay='.2s'>Start Teaching Today!</h1>
                                <h5 class="mb-35 wow fadeInUp2 animated" data-wow-delay='.3s'>Manage your requests from the "Manage requests" page .</h5>
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="slider-img-box-two">
                                <div class="chose-img-wrapper mb-50 pos-rel">
                                    ...
                                    <div class="feature tag_02"><span><img src="../assets/img/icon/catalog.svg" alt=""></span> 120+ Partners</div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section-title section-title-2 text-center mb-60">
                        <h5 class="bottom-line left-line mb-25 pl-40 pr-40">LinguaLink's Partners!</h5>
                        <h2 class="mb-25">What our partners say About Us</h2>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                    ...
                    <div class="testimonial-active-full owl-carousel">
                        ...
                        <div class="item">
                            <div class="testimonial-wrapper test-wrapper-full text-center mb-30">
                                ...
                                <h5>The other partners are great.</h5>
                                <div class="testimonial-authors__content mt-65">
                        ...
                        <div class="item">
                            <div class="testimonial-wrapper test-wrapper-full text-center mb-30">
                                ...
                                <h5>I love this! so amazing to join from home.</h5>
                                <div class="testimonial-authors__content mt-65">
