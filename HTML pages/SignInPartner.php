...
<html>
  ...
  <body>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="contact-form-wrapper text-center mb-30">
                            <h2 class="mb-45">Welcome Back, Partner!</h2>
                            <form id="loginForm" action="../assets/php/LoginPartner.php" method="post" class="comments-form contact-form">
                                <div class="mb-30">
                                    <label>Username: <br>
                                ...
                                <a href="SignInLearner.php"  style="background-color: white; color:orange;" class="theme_btn message_btn mt-20">Not a Partner? Click to Sign in as a Learner</a>
    ...
    <!-- Check for an error message in the URL parameter and display it using SweetAlert -->
